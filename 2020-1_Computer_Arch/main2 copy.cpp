            ...
            if(str=="loadinst"){
                ...
                if(s=="exit"){fclose(fout); return 0;}
                    ...
                    if(ho<cnt){
                        ...
                        printf("Executed %d instructions",ho+1);
                    }else if(ho>cnt){
                        printf("Executed %d instructions",cnt);
                    }else if(ho==cnt){
                        printf("Executed %d instructions",ho);
                    }
                }
            }
            int instcnt=0;            /// 유효 명령어 카운트 
            string s1="";
            int idx=0;
            for (int j = 0; j < i; j++)
            {
                ...
                if(s1.size()==32){
                    ...
                    if(op=="000000" && (funt=="100000"|| funt=="100001")){ //add and addu
                       ...
                       if(str=="read"){printf("inst %d: %08x ",idx, address);}
                        ...
                        if(str=="read"){printf("lui $%d, 0x%08x\n", rt1, imm2);}
                        else{
                            regi[rt1]=imm2<<16;
                            regi[32]+=4;
                        }
                       ...
                       if(str=="read"){ printf("inst %d: %08x ",idx, address);}
                        ...
                        printf("inst %d: unknown instrucion\n", idx);
                        idx++;
                    }           
                    s1="";
                }
