                    ...
                    if(op=="000000" && (funt=="100000"|| funt=="100001")){ //add and addu
                       ...
                       if(str=="read"){printf("inst %d: %08x ",idx, address);}
                        ...
                        if(str=="read"){printf("lw $%d, %d($%d)\n", rt1, offset2, rs1);}
                                ...
                                if(!checkrange(offset2+regi[rs1])){
                                    flag=true;
                                ...
                                int dataval=0;
                                for(int i=offset2+regi[rs1]-0x10000000; i<offset2+4; i++){
                                    dataval+=datamem[i]<<(24-8*i);
                                }
                                // printf("%08x\n", dataval);
                                regi[rt1]=dataval;
                                regi[32]+=4;
                        ...
                        if(op=="001000"){  //addi
                            ...
                            if(str=="read"){ printf("addiu $%d, $%d, %d\n", rt1, rs1, imm); }
                                ...
                                printf("addiu address: %08x\n", address);
                                printf("imm?: %u %d %08x\n",imm, imm, imm);
                                printf("addiu-regi: %d %08x\n", regi[rt1], regi[rt1]);
                                regi[rt1]= (unsigned int)regi[rs1]+(unsigned int)imm;
                                // long long val=(long long)(unsigned int)regi[rs1]+(long long)(unsigned int)imm;
                                // printf("val: %I64x\n", val);
                                printf("regi: %08x\n", regi[rt1]);
                                regi[32]+=4;
                                int idx=regi[32]/4;
                        ...
                        if(str=="read"){printf("sh $%d, %d($%d)\n", rt1, offset2, rs1);}
                            ...
                            datamem[offset2+regi[rs1]-0x10000000]=(unsigned long long)regi[rt1]>>16;
                            regi[32]+=4;
                            int idx=regi[32]/4;
                            valinst++;
                            if(valinst==cnt) break;
                       ...
                       if(str=="read"){ printf("sw $%d, %d($%d)\n", rt1, offset2, rs1);}
                           ...
                           if(!checkrange(offset2+regi[rs1])){
                            ...
                            printf("sw address: %08x\n", address);
                            printf("offset, rs rt: %d %d %d\n", offset2, rs1, rt1);
                            printf("regi val: %08x\n", regi[rt1]);
                       ...
                       if(str=="read"){ printf("inst %d: %08x ",idx, address);}
                        ...
                        if(funt=="100010"){  //sub
                            ...
                            if(str=="read"){printf("subu $%d, $%d, $%d\n",rd1, rs1, rt1); }
                                ...
                                regi[rd1]=(unsigned long long)regi[rs1]-(unsigned long long)regi[rt1];
                                regi[32]+=4;
                                int idx=regi[32]/4;
                                valinst++;
                                if(valinst==cnt) break;
                        ...
                        if(op=="001010"){      //slti
                            if(str=="read"){printf("slti $%d, $%d, %d\n",rt1,rs1, imm2);}
                                ...
                                regi[rt1]=((signed long long)regi[rs1])<(signed long long)imm2;
                                regi[32]+=4;
                                int idx=regi[32]/4;
                                valinst++;
                                if(valinst==cnt) break;
                            ...
                            if(str=="read"){printf("sltiu $%d, $%d, %d\n",rt1,rs1, imm2);}
                                ...
                                regi[rt1]=(unsigned long long)regi[rs1]<(unsigned long long)imm2;
                                regi[32]+=4;
                                int idx=regi[32]/4;
                                valinst++;
                                if(valinst==cnt) break;
